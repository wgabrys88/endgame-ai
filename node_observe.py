...
def run(ctx):
    ...
    patch = {"observed_at": obs.get("observed_at"), "desktop_tree_text": obs.get("desktop_tree_text", ""), "action_index": obs.get("action_index", {}), "observation_artifact": obs.get("observation_artifact", {}), "rendered_node_count": obs.get("rendered_node_count"), "max_llm_nodes": obs.get("max_llm_nodes"), "llm_node_limit_hit": obs.get("llm_node_limit_hit"), "observation": observation}
