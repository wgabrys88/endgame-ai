...
import bus
DATASHEET = bus.datasheet('error', kind='mechanical_recovery_router', inputs=['last_node', 'last_error', 'current_step'], signals=['planner', 'reflect', 'halt'], writes=['error_handled', 'recovery'], record_type=None)
