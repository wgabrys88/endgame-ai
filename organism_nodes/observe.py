...
DATASHEET = bus.datasheet(
    ...
    signals=["screen_ready", "error"],
    writes=["observed_at", "desktop_tree_text", "focused_title", "fresh_scan", "observation_artifact"],
    record_type=None,
)
...
def run(ctx):
    ...
    return bus.emit(
        ...
        evidence={"focused_title": obs.get("focused_title"), "fresh_scan": obs.get("fresh_scan")},
    )
