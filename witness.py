...
output), and — eyes are seated — `vision.grab()` to re-photograph now and `vision.windows()` to list
the visible top-level windows with their titles. You have NO click/move/scroll. A fresh screen
PHOTOGRAPH is attached to THIS request; look at it and judge by what it shows.
