"""Export the living topology as a Mermaid state diagram.

This command intentionally avoids importing node modules so it works in docs/CI
environments that do not have Windows UIA/comtypes installed.
"""
