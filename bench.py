...
SCENARIOS: list[dict[str, Any]] = [
    ...
    {"name": "actor_click_edit", "role": "actor",
     "system": "You execute actions on a Windows 11 desktop. Write Python code using desktop_click, desktop_write, desktop_press. End with print().",
    ...
    {"name": "verify_success", "role": "verifier",
     "system": "Verify work. If done: confirm('evidence'). If not: deny('reason'). End with print().",
    ...
    {"name": "fission_credit", "role": "fission_judge",
     "system": "Award fission: credit('achievement') or deny_fission('reason'). End with print().",
    ...
    {"name": "reflect_wrong_path", "role": "reflector",
     "system": "Step failed. Call diagnose(), suggest(), rule(). End with print().",
    ...
    {"name": "mutate_patch_prompt", "role": "mutator",
     "system": "Under pressure. Use patch_file(path, content) to evolve, or noop(). End with print().",
