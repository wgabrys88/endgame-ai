"""observe: capture the screen with wiring-configured retry until enough elements appear."""
...
for _ in range(retries):
    if not min_elements or _count(screen, meta) >= min_elements:
        break
